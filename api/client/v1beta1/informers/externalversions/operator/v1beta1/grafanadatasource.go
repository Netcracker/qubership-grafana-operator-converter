...
type GrafanaDatasourceInformer interface {
	...
	Lister() v1beta1.GrafanaDatasourceLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GrafanaIntegreatlyV1beta1().GrafanaDatasources(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GrafanaIntegreatlyV1beta1().GrafanaDatasources(namespace).Watch(context.TODO(), options)
			},
		},
		&operatorv1beta1.GrafanaDatasource{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *grafanaDatasourceInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operatorv1beta1.GrafanaDatasource{}, f.defaultInformer)
}

func (f *grafanaDatasourceInformer) Lister() v1beta1.GrafanaDatasourceLister {
	return v1beta1.NewGrafanaDatasourceLister(f.Informer().GetIndexer())
}
