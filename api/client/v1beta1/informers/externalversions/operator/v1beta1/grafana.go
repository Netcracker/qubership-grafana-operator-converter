	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.GrafanaIntegreatlyV1beta1().Grafanas(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GrafanaIntegreatlyV1beta1().Grafanas(namespace).Watch(context.TODO(), options)
			},
		},
		&operatorv1beta1.Grafana{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *grafanaInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operatorv1beta1.Grafana{}, f.defaultInformer)
}

func (f *grafanaInformer) Lister() v1beta1.GrafanaLister {
	return v1beta1.NewGrafanaLister(f.Informer().GetIndexer())
}
