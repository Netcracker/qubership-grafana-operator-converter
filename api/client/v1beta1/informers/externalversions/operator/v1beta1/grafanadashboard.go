...
type GrafanaDashboardInformer interface {
	...
	Lister() v1beta1.GrafanaDashboardLister
}
...
func (f *grafanaDashboardInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&operatorv1beta1.GrafanaDashboard{}, f.defaultInformer)
}

func (f *grafanaDashboardInformer) Lister() v1beta1.GrafanaDashboardLister {
	return v1beta1.NewGrafanaDashboardLister(f.Informer().GetIndexer())
}
