...
// GrafanaDataSourceFields defines the desired fields of GrafanaDataSource
// +k8s:openapi-gen=true
...
// GrafanaDataSourceJsonDerivedFields contains the derived json fields
// +k8s:openapi-gen=true
...
// GrafanaDataSourceJsonExemplarTraceIdDestinations contains the exemplar trace id destinations
// +k8s:openapi-gen=true
...
// GrafanaDataSourceJsonTracesToLogs contains the json traces
// +k8s:openapi-gen=true
...
// GrafanaDataSourceJsonServiceMap contains the json service map
// +k8s:openapi-gen=true
type GrafanaDataSourceJsonServiceMap struct {
	DatasourceUid string `json:"datasourceUid,omitempty"`
}

// GrafanaDataSourceJsonSearch contains the json search params
// +k8s:openapi-gen=true
type GrafanaDataSourceJsonSearch struct {
	Hide bool `json:"hide,omitempty"`
}

// GrafanaDatasourceJsonNodeGraph contains the json node graph params
// +k8s:openapi-gen=true
