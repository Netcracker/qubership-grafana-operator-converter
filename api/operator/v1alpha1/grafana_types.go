...
// ReadinessProbeSpec defines the readiness probe definition of Grafana
// +k8s:openapi-gen=true
...
// LivenessProbeSpec defines the liveness probe definition of Grafana
// +k8s:openapi-gen=true
...
// JsonnetConfig contains the jsonnet options
// +k8s:openapi-gen=true
...
// GrafanaConfigDatabase is the configuration for grafana DB
// +k8s:openapi-gen=true
...
// GrafanaConfigRemoteCache is the configuration for grafana remote cache
// +k8s:openapi-gen=true
...
// GrafanaConfigSecurity is the configuration for grafana security
// +k8s:openapi-gen=true
...
// GrafanaConfigUsers is the configuration for grafana users
// +k8s:openapi-gen=true
...
// GrafanaConfigAuth is the configuration for grafana authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthBasic is the configuration for grafana Basic authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthAnonymous is the configuration for grafana Anonymous authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthSaml is the configuration for grafana SAML(Security Assertion Markup Language) authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthAzureAD is the configuration for grafana AzureAD authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthGoogle is the configuration for grafana Google authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthGithub is the configuration for grafana Github authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthGitlab is the configuration for grafana Gitlab authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthGenericOauth is the configuration for grafana Oauth authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthJwt is the configuration for grafana Jwt authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthOkta is the configuration for grafana Okta authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthLdap is the configuration for grafana Ldap authorization
// +k8s:openapi-gen=true
...
// GrafanaConfigAuthProxy is the configuration for grafana authorization proxy
// +k8s:openapi-gen=true
...
// GrafanaConfigDataProxy is the configuration for grafana data proxy
// +k8s:openapi-gen=true
...
// GrafanaConfigAnalytics is the configuration for grafana analytics
// +k8s:openapi-gen=true
...
// GrafanaConfigDashboards is the configuration for grafana dashboards
// +k8s:openapi-gen=true
...
// GrafanaConfigSmtp is the configuration for grafana Smtp
// +k8s:openapi-gen=true
...
// GrafanaConfigLive is the configuration for grafana live
// +k8s:openapi-gen=true
...
// GrafanaConfigLog is the configuration for grafana log
// +k8s:openapi-gen=true
...
// GrafanaConfigLogFrontend is the configuration for grafana log frontend
// +k8s:openapi-gen=true
...
// GrafanaConfigLogConsole is the configuration for grafana log console
// +k8s:openapi-gen=true
...
// GrafanaConfigMetrics is the configuration for grafana metrics
// +k8s:openapi-gen=true
...
// GrafanaConfigMetricsGraphite is the configuration for grafana graphite metrics
// +k8s:openapi-gen=true
...
// GrafanaConfigSnapshots is the configuration for grafana snapshots
// +k8s:openapi-gen=true
...
// GrafanaConfigExternalImageStorage is the configuration for grafana external image storage
// +k8s:openapi-gen=true
type GrafanaConfigExternalImageStorage struct {
	Provider string `json:"provider,omitempty" ini:"provider,omitempty"`
}

// GrafanaConfigExternalImageStorageS3 is the configuration for grafana external image storage S3
// +k8s:openapi-gen=true
...
// GrafanaConfigExternalImageStorageWebdav is the configuration for grafana external image storage Webdav
// +k8s:openapi-gen=true
...
// GrafanaConfigExternalImageStorageGcs is the configuration for grafana external image storage Gcs
// +k8s:openapi-gen=true
...
// GrafanaConfigExternalImageStorageAzureBlob is the configuration for grafana external image storage AzureBlob
// +k8s:openapi-gen=true
...
// GrafanaConfigAlerting is the configuration for grafana alerting
// +k8s:openapi-gen=true
...
// GrafanaConfigUnifiedAlerting is the configuration for grafana unified alerting
// +k8s:openapi-gen=true
...
// GrafanaConfigPanels is the configuration for grafana panels
// +k8s:openapi-gen=true
...
// GrafanaConfigPlugins is the configuration for grafana plugins
// +k8s:openapi-gen=true
...
// GrafanaConfigRendering is the configuration for grafana rendering
// +k8s:openapi-gen=true
...
// GrafanaConfigFeatureToggles is the configuration for grafana feature toggles
// +k8s:openapi-gen=true
