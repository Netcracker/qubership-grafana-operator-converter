...
preserve_checksum=$(grep 'checksum/grafana-resources-config:' "${render_dir}/deployment-preserve-targets.yaml")
delete_checksum=$(grep 'checksum/grafana-resources-config:' "${render_dir}/deployment-delete-targets.yaml")
