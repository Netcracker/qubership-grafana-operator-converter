...
[[ $(grep -c '^kind: Role$' "${explicit_render}") -eq 3 ]]
[[ $(grep -c '^kind: RoleBinding$' "${explicit_render}") -eq 3 ]]
...
[[ $(grep -c '^    namespace: monitoring$' "${explicit_render}") -eq 3 ]]
...
grep -q '^              value: "monitoring,product-a,product-b"$' \
  "${render_dir}/deployment-explicit-namespaces.yaml"
...
[[ $(grep -c '^kind: Role$' "${override_render}") -eq 3 ]]
[[ $(grep -c '^  namespace: monitoring$' "${override_render}") -eq 2 ]]
[[ $(grep -c '^  namespace: operators$' "${override_render}") -eq 2 ]]
[[ $(grep -c '^  namespace: product-a$' "${override_render}") -eq 2 ]]
[[ $(grep -c '^    namespace: operators$' "${override_render}") -eq 3 ]]
